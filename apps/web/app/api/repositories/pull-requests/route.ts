...
import { checkRepositoryRequest, getOpenPullRequests } from "@/lib/repositories"
...
export async function GET(request: Request) {
  ...
  try {
    ...
    return Response.json(
      { error: "We couldn't fetch open pull requests from this repository. Please try again." },
      { status: 502 },
    )
  }
}
